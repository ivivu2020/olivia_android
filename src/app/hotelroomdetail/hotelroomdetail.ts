    ...
    self.storage.get('email').then(email => {
      if (email) {
        ...
        self.booking.CheckOutDate = self.searchhotel.CheckOutDate,
          self.booking.roomNb = MealTypeRates.TotalRoom,
          ...
          //Lấy số phòng theo số phòng api trả về
          self.Roomif.roomnumber = MealTypeRates.TotalRoom ? MealTypeRates.TotalRoom : (self.searchhotel.roomnumber ? self.searchhotel.roomnumber.toString() : objjsonroom.TotalNight.toString()),
          //self.Roomif.roomnumber = self.searchhotel.roomnumber ? self.searchhotel.roomnumber.toString() : objjsonroom.TotalNight.toString(),
