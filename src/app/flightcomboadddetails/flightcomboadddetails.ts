            ...
            if (i == 0) {
              if (infocus.ho && infocus.ten) {
                ...
                if (infocus.ho) {
                  ...
                  item = { id: id, text: "Người lớn " + number + "", PassengerType: 0, FirstName: '', LastName: '', BirthDay: null, Gender: null, Baggage: 0, ReturnBaggage: 0, hoten: infocus.ten ? infocus.ten : '' }
                }
              }
            } else {
      ...
      if (checktext) {
        if (this.phone) {
          if (this.phonenumber(this.phone)) {
            ...
            // }
            if (co == 0) {
              //PDANH 17/07/2019: Chia ra trường hợp có allotment & vmb jetstar cho phép thanh toán online và chạy tool giữ vé
              ...
              for (let i = 0; i < this.arradult.length; i++) {
                ...
                if (texthoten.length > 2) {
                  ...
                  item = { PassengerType: this.arradult[i].PassengerType, FirstName: name, LastName: texthoten[0], BirthDay: this.arradult[i].BirthDay, Gender: this.arradult[i].Gender, DepartBaggage: this.arradult[i].Baggage, Baggage: this.arradult[i].Baggage, ReturnBaggage: this.arradult[i].ReturnBaggage };
                } else if (texthoten.length > 1) {
                  item = { PassengerType: this.arradult[i].PassengerType, FirstName: texthoten[1], LastName: texthoten[0], BirthDay: this.arradult[i].BirthDay, Gender: this.arradult[i].Gender, DepartBaggage: this.arradult[i].Baggage, Baggage: this.arradult[i].Baggage, ReturnBaggage: this.arradult[i].ReturnBaggage };
                }
                else if (texthoten.length == 1) {
                  item = { PassengerType: this.arradult[i].PassengerType, FirstName: "", LastName: texthoten[0], BirthDay: this.arradult[i].BirthDay, Gender: this.arradult[i].Gender, DepartBaggage: this.arradult[i].Baggage, Baggage: this.arradult[i].Baggage, ReturnBaggage: this.arradult[i].ReturnBaggage };
                }
