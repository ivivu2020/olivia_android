  ...
  openWebpage(url: string) {
    ...
    browser.on('exit').subscribe(() => {
      ...
      var options = {
        ...
        form:
        {
          BookingCode: se.book.code,
          DepartATCode: se.book.DepartATCode,
          ReturnATCode: se.book.ReturnATCode,
          FromPlaceCode: se.listcars.TransferBooking.fromPlaceCode
        }
      };
      request(options, function (error, response, body) {
          ...
          if (json.Error == 0) {
            ...
            request(options1, function (error, response, body) {
              if (response.statusCode != 200) {
                var objError = {
                  page: "combochoosebank",
                  func: "combochoosebank-mCheckBooking",
              ...
              if (error) {
                error.page = "combochoosebank";
                error.func = "combochoosebank-mCheckBooking";
