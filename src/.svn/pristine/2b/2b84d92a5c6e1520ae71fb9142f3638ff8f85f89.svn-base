...
export class C {
    ...
    private static HOSTS: any = {
      ...
      //dev: {urlPost: 'https://svc1.ivivu.com',urlGet: 'https://www.ivivu.com', urlContracting: 'https://pay.ivivu.com', urlMobile: 'https://gate.ivivu.com',urlBlog: 'https://svc3.ivivu.com',urlGate: 'https://gate.ivivu.com',urlPayment: 'https://gate.ivivu.com/payment', urlSVC3: 'https://svc3.ivivu.com/api/'},
    ...
    public static writeErrorLog(objError:any,response) {
      ...
      var obj = { 
       "content": "Error from page: "+ (objError.page || "") + " - function: " + (objError.func|| "") + " - params: " + (objError.param || "" )+ " - Content: " + (objError.stack || "") + "response" +JSON.stringify(response) + " - AppVersion: 1.6.1"  ,
